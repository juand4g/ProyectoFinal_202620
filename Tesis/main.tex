...
\begin{figure}[H]
	...
	\caption[Exactitud y precisi\'on del periodograma de Lomb--Scargle, por tipo de estrella]{Izquierda: distribuci\'on del error relativo del periodo recuperado por el periodograma de Lomb--Scargle (con correcci\'on de alias), por tipo de estrella. Derecha: frecuencia recuperada vs. frecuencia catalogada, con la identidad $f_{LS}=f_{\text{cat}}$ y las diagonales correspondientes a los m\'ultiplos $\times2$ y $\times3$ del periodo. Elaboraci\'on propia sobre 500 binarias, 500 Cefeidas cl\'asicas y 500 RR Lyrae del OCVS.}
...
\begin{figure}[H]
	...
	\caption[Exactitud y precisi\'on del m\'etodo de m\'inima entrop\'ia, por tipo de estrella]{Izquierda: distribuci\'on del error relativo del periodo recuperado por el m\'etodo de m\'inima entrop\'ia (con correcci\'on de alias), por tipo de estrella. Derecha: frecuencia recuperada vs. frecuencia catalogada, con la identidad $f_{\text{entrop\'ia}}=f_{\text{cat}}$ y las diagonales de m\'ultiplos $\times2$ y $\times3$. Misma muestra que la Figura~\ref{fig:ls-resumen}.}
